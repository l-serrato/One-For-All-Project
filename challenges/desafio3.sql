SELECT pessoa_usuaria.nome_pessoa_usuaria, COUNT(musicas_ouvidas.reproducao_id), SUM(total_minutos.duracao_segundos)/60
FROM usuario_tabela AS pessoa_usuaria
INNER JOIN reprod_tabela AS musicas_ouvidas
ON pessoa_usuaria.usuario_id = musicas_ouvidas.usuario_id
