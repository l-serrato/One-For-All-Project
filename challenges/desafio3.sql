SELECT pessoa_usuaria.nome_pessoa_usuaria as pessoa_usuaria, COUNT(musicas_ouvidas.reproducao_id) as musicas_ouvidas, ROUND(SUM(total_minutos.duracao_segundos)/60, 2) as total_minutos
